...
#ifndef JSONLD_FEATURE_WRITER_H
#define JSONLD_FEATURE_WRITER_H

#include "transform/FileFeatureWriter.h"

#include "rdf/PluginRDFDescription.h"

class JsonLDFileWriter;

class JsonLDFeatureWriter : public FileFeatureWriter
{
public:
    JsonLDFeatureWriter();
    virtual ~JsonLDFeatureWriter();
    ...
    virtual QString getWriterTag() const { return "jsld"; }
...
private:
    ...
    typedef map<TrackId, QString> TrackTimelineMap;
    TrackTimelineMap m_trackTimelineGuids;
